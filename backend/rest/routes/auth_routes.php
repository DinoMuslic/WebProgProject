...
Flight::group('/auth', function() {
     ...
     *              @OA\Property(property="email", type="string", example="example@example.com", description="student email address"),
    ...
    Flight::route('POST /login', function() {
        ...
        $student = Flight::get('auth_service')->get_user_by_email($payload['email']);
        ...
        Flight::json(
            array_merge($student, ['token' => $token])
        );
    });
